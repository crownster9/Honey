...
export default function Hero() {
 ...
 return(
  <section className="-my-20 hero-hatch overflow-hidden pt-30 px-[5vw] bg-[#013e37] md:px-10 w-full">
    <div className="md:flex gap-2 ">
    <div className="flex-col space-y-8 md:w-1/2">
      <div className="">
        <div data-aos="slide-up" data-aos-once="true" data-aos-duration="1000" className="flex items-center tracking-widest font-bold gap-2 text-sm border-[0.1px] border-(--cream)/50 w-fit p-2 rounded-full">
       ...
       <h1 data-aos="fade-up" data-aos-once="true" data-aos-duration="1000"  className="font-serif font-medium text-6xl leading-[0.82] tracking-[-0.065em] text-[clamp(4rem,8.2vw,8.5rem)] max-w-190 text-(--cream)">
          Nature's <em className="text-[#ffefb3] italic">golden</em> ritual.
        </h1>
        <p className="text-(--cream)/50 font-semibold" data-aos="zoom-in" data-aos-once="true" data-aos-duration="1000">
          Small-batch honey gathered from living wildflower fields. Slow harvested, gently bottled, and left close to the hive.</p>
       <div data-aos="slide-up" data-aos-once="true" data-aos-duration className="md:flex space-y-4 gap-2 w-full items-center">
        <a href="#honey" className="inline-flex items-center gap-2.5 cursor-pointer bg-(--butter) text-(--green) rounded-full px-5.5 py-3.75 hover:shadow-[0_12px_30px_rgba(255,239,179,0.2)] border-none hover:-translate-y-0.75 transition-all duration-300 tracking-wide font-extrabold text-lg">Explore the harvest <span>🍯</span>
</a>
    ...
    <div data-aos="fade-left" data-aos-once="true" data-aos-duration="1000"  className="relative min-h-[570px] grid place-items-center [perspective:1000px]">

  {/* the gold ring around the jar */}
  <div className="gold-ring absolute md:w-100.5 md:h-100.5 w-90 h-90 rounded-full rotate-[-16deg] opacity-85 z-2" />

  {/* the orbiting bees */}
  <div className="animate-orbit absolute w-[min(350px,100vw)] md:w-[min(450px,100vw)]  md:h-[min(450px,100vw)] h-[min(350px,100vw)] border border-dashed border-white/20 rounded-full z-5 pointer-events-none">
  ...
  {/* the trust badge */}
  <div className="absolute right-0 bottom-[4%] z-[6] w-37.5 h-37.5  rounded-full bg-[#ffefb3] text-[#013e37] flex flex-col items-center justify-center gap-2.5 text-center p-4 shadow-[0_20px_46px_rgba(0,0,0,0.22)]">
  ...
  <div className="relative w-[min(300px,60vw)] md:w-[min(350px,80vw)]  aspect-square rounded-[36px] overflow-hidden border border-white/20 shadow-[0_30px_80px_rgba(0,0,0,0.22)] z-[3]">
    <img
